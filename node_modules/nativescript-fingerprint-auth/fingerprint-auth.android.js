...
var FingerprintAuth = (function () {
    ...
    FingerprintAuth.prototype.verifyWithCustomAndroidUI = function (resolve, reject, authenticationCallback) {
        this.fingerPrintManager.authenticate(authenticationCallback, app.android.foregroundActivity.getSupportFragmentManager());
    };
    FingerprintAuth.prototype.verifyFingerprint = function (options) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            try {
                var hasSupportFragment = app.android.foregroundActivity.getSupportFragmentManager !== undefined;
                if (options.useCustomAndroidUI && !hasSupportFragment) {
                    ...
                    app.android.foregroundActivity.onActivityResult = function (requestCode, resultCode, data) {
